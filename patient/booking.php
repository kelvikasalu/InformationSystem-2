...
<body>
    ...
    if ($stmt) {
        ...
        if ($result->num_rows > 0) {
            ...
            echo "Error: No patient found with the provided email.";
            exit; // Exit to avoid further processing
        }
    } else {
        // Handle case where the statement couldn't be prepared
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                        ...
                                        <tr>
                                            <td>
                                                <div style="margin-bottom: 15px; color: #856404; background-color: #fff3cd; border: 1px solid #ffeeba; padding: 10px; border-radius: 4px;">
                                                    <strong>Note:</strong> You can only book one appointment per session. Multiple bookings for the same session are not allowed.
                                                </div>
